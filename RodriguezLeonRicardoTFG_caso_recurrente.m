...
% representación de la evolución tras resolver el sistema
...
% descomentar y comentar lo siguiente para obtener la gráfica de evolución
% del sistema con control hasta t=200
% u(1:M) = 0;
% for r=1:(M-1)
%     t(r+1) = t(r) + h;
%     F1 = F(t(r),Y(:,r),u(r));
